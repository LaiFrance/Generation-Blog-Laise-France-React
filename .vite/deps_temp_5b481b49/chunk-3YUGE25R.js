...
var GlobalPrefixedRule = function() {
  function GlobalPrefixedRule2(key, style2, options) {
    ...
    this.rule = options.jss.createRule(selector, style2, _extends3({}, options, {
      parent: this
    }));
  }
...
function handlePrefixedGlobalRule(rule, sheet) {
  ...
  for (var prop in style2) {
    ...
    sheet.addRule(selector, style2[prop], _extends3({}, options, {
      selector
    }));
    delete style2[prop];
  }
    ...
    for (var prop in style2) {
      ...
      if (isNested) {
        ...
        if ("replaceRule" in container) {
          container.replaceRule(name, style2[prop], _extends4({}, options, {
            selector
          }));
        } else {
          container.addRule(name, style2[prop], _extends4({}, options, {
            selector
          }));
        }
...
@material-ui/styles/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3YUGE25R.js.map
